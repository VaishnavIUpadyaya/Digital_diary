...
export default function EditProfile() {
  ...
  return (
    <div className="bg-gradient-to-b from-[#C8E0F5] via-[#F3C9D8] to-[#FBC7E0] min-h-screen">
      {/* TITLE — DESKTOP SAME */}
      <h1
        className="text-black text-6xl font-bold font-[marcellus] py-16 text-center
                   max-md:text-4xl max-md:py-10"
      >
        Edit Profile
      </h1>
      ...
      <div className="flex justify-center">
        <div
          className="flex flex-col bg-white/30 backdrop-blur-md p-10 rounded-xl shadow-lg
        ...
        >
          ...
          <button
            className="w-50 h-13 bg-[#ECA49C] rounded-[5px] text-black font-bold
                       font-[marcellus] hover:text-white hover:bg-[#a14e87] mx-auto
                       max-md:w-full"
            onClick={async () => {
