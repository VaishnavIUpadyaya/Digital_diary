  ...
  return (
    ...
    >
      ...
      {flashbacks.map((entry) => (
        <div
          key={entry.id}
          className="bg-blue-100 rounded-xl shadow-lg p-10 max-w-xl
                     text-center font-[marcellus] mb-6
                     max-md:p-5 max-md:mx-4 max-md:w-full"
        >
      ...
      <button
        type="button"
        className="bg-[#a1f1deff] p-3 h-10 w-30 text-black mt-6 rounded
                   font-[marcellus] font-bold
                   max-md:mx-auto"
