...
export default function EntriesPage() {
  ...
  return (
    <div
      ...
      className="min-h-screen p-10 max-md:p-4"
    >
      ...
      {message && (
        <p className="text-[#a1f1deff] text-xl font-bold mb-5
                      max-md:text-base max-md:text-center">
          {message}
        </p>
      )}

      {/* FILTERS — DESKTOP SAME */}
